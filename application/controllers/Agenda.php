...
class Agenda extends CI_Controller {
	...
	public function index($id=null) {
		...
		$listaPaginada = $this->Agenda_model->pagination($this->config->item("per_page"), $page, val($_GET,"busca"));
		...
		$dados = $this->Agenda_model->get($id);
		...
		//recupera os tipos possiveis de Agenda
		$tiposAgenda = $this->Agenda_model->tiposAgenda;
		$areasAgenda = $this->Agenda_model->areasAgenda;
		$niveis = [""] + $this->Agenda_model->secureLevels;

		
		$this->load->view('agenda', ["listaPaginada"=>$listaPaginada,
										"dados"=>$dados,
										"setores"=>$setores,
										"grupos"=>$grupos,
										"niveis"=>$niveis,
										"tiposAgenda"=>$tiposAgenda,
										"areasAgenda"=>$areasAgenda]);
